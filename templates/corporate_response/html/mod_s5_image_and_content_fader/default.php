...
<?php
	...
	$doc->addCustomTag('<script src="templates/corporate_response/html/mod_s5_image_and_content_fader/js/jd.gallery.js" type="text/javascript"></script>');
		...
		<div class="content" style="position:relative;z-index:0">
			...
			<?php if ($s5stretchimage == "stretch") { ?>
				<div id="myGallery_height">
					<img id="myGallery_height_img" alt="" src="<?php echo $picture1_s5_iacf; ?>"></img>
				</div>
			<?php } ?>
			<div id="s5_iacf_content_wrap" style="display:none">
				...
				<div class="imageElement" style="z-index:0;">
					...
					<a href="<?php if ($picture1link_s5_iacf != "") {echo $picture1link_s5_iacf;} else { echo "javascript:;";}?>" class="open"></a>
				...
				<div class="imageElement" style="z-index:0;">
					...
					<a href="<?php if ($picture2link_s5_iacf != "") {echo $picture2link_s5_iacf;} else { echo "javascript:;";}?>" class="open"></a>
				...
				<div class="imageElement" style="z-index:0;">
					...
					<a href="<?php if ($picture3link_s5_iacf != "") {echo $picture3link_s5_iacf;} else { echo "javascript:;";}?>" class="open"></a>
				...
				<div class="imageElement" style="z-index:0;">
					...
					<a href="<?php if ($picture4link_s5_iacf != "") {echo $picture4link_s5_iacf;} else { echo "javascript:;";}?>" class="open"></a>
				...
				<div class="imageElement" style="z-index:0;">
					...
					<a href="<?php if ($picture5link_s5_iacf != "") {echo $picture5link_s5_iacf;} else { echo "javascript:;";}?>" class="open"></a>
				...
				<div class="imageElement" style="z-index:0;">
					...
					<a href="<?php if ($picture6link_s5_iacf != "") {echo $picture6link_s5_iacf;} else { echo "javascript:;";}?>" class="open"></a>
				...
				<div class="imageElement">
					...
					<a href="<?php if ($picture7link_s5_iacf != "") {echo $picture7link_s5_iacf;} else { echo "javascript:;";}?>" class="open"></a>
				...
				<div class="imageElement">
					...
					<a href="<?php if ($picture8link_s5_iacf != "") {echo $picture8link_s5_iacf;} else { echo "javascript:;";}?>" class="open"></a>
				...
				<div class="imageElement">
					...
					<a href="<?php if ($picture9link_s5_iacf != "") {echo $picture9link_s5_iacf;} else { echo "javascript:;";}?>" class="open"></a>
				...
				<div class="imageElement">
					...
					<a href="<?php if ($picture10link_s5_iacf != "") {echo $picture10link_s5_iacf;} else { echo "javascript:;";}?>" class="open"></a>
