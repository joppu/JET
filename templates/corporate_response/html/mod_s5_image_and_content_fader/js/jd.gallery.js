...
var gallery = {
   ...
   // start jv
	...
	initInfoSlideshow: function() {
		...
		this.slideInfoZoneInner = new Fx.Morph(new Element('div', {'id': 'slideInfoZoneInner'}).injectInside(this.slideInfoZone.element));
		var slideInfoZoneTitle = new Element('h2').injectInside(this.slideInfoZoneInner.element);
		var slideInfoZoneDescription = new Element('p').injectInside(this.slideInfoZoneInner.element);
